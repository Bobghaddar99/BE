...
class AutomappingPage(QWidget):
    def __init__(self, dashboard_gui):
        ...
        confirm_button_map.clicked.connect(lambda: self.process_map_name())
    ...
    def process_map_name(self):
        ...
        output_dir = r"/home/bob/Desktop" # Change this to your preferred directory
...
class LiftingPage(QWidget):
    def __init__(self, dashboard_gui):
        ...
        self.up_arrow = QPushButton("EBBA YA HSSEIN", self)
        self.down_arrow = QPushButton("ABAYTA KTIRR", self)
