...
class PurePursuit:
    def __init__(self):
        ...
        self.is_in_debug_mode = (
             rospy.get_param("~debug","true") == "true"
        )

        # Publishers
        self.cmd_vel = rospy.Publisher("/cmd_vel_test", Twist, queue_size=10)
    ...
    def update_odometry(self, msg: Odometry):   #######update the odom (place of the robot with rescpet to the map frame)
        """
